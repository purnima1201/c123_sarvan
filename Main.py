...
X_train, X_test, y_train, y_test = train_test_split(
    X, y, random_state=9, train_size=7500, test_size=50)
...
while(True):
  ...
  try:
    ...
    #if   these two lines are commented camera opens but if i uncoment these two camera doesn't open
    # try uncommenting now

    #camera light has been turn on but camers did not open
